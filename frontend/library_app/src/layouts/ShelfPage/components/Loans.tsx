    ...
    useEffect(() => {
        const fetchUserCurrentLoans = async () => {
            if (authState && authState.isAuthenticated) {
                ...
                const shelfCurrentLoansResponse = await fetch(url, requestiOptions);
                                ...
                                <div className="row mt-3 mb-3">
                                    <div className="col-4 col-md-4 container">
                                        {shelfCurrentLoan.book?.img ?
                                            ...
                                            :
                                            <img src={require('./../../../Images/BooksImages/book-1.png')} width='226' height='349' alt='Book' />
                                        }
                                    </div>
                            ...
                            <div key={shelfCurrentLoan.book.id}>
                                <div className='d-flex justify-content-center align-items-center'>
                                    {shelfCurrentLoan.book?.img ?
                                        <img src={shelfCurrentLoan.book?.img} width='226' height='349' alt='Book' />
                                        :
                                        <img src={require('./../../../Images/BooksImages/book-1.png')}
